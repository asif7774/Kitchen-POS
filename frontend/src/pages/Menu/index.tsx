...
const MenuPage: React.FC = () => {
        ...
        if (res.success && res.data) {
          ...
          if (res.data.length > 0) {
            const idToSelect =
              selectId ??
              activeMenuId ??
              res.data.find((m) => m.is_default)?.id ??
              res.data[0].id;
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 p-6 overflow-hidden">
      <div className="w-full mx-auto mb-4 flex items-center justify-between bg-white p-4 rounded shadow-sm">
              ...
              showModal({
                ...
                actions: (
                  <>
                    ...
                    <Button type="submit" form="menu-form" variant="primary">
                      Create
                    </Button>
                  </>
                ),
              ...
              <Button
                ...
                onClick={() => {
                  showModal({
                    ...
                    content: (
                      <CloneMenuModal
                        sourceMenu={activeMenu}
                        onSuccess={(newId) => {
                          hideModal();
                          void fetchMenus(newId);
                        }}
                      />
                    ),
                    actions: (
      ...
      <div className="flex w-full gap-6 mx-auto h-[calc(100%-80px)]">
